      ...
      <div className="mt-10 grid gap-6 sm:grid-cols-3">
        {socialLinks.map((social, i) => (
          <Reveal key={social.name} delay={i * 0.1}>
            ...
            >
              <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-xl border border-line bg-glass transition-colors group-hover:border-foreground/30 group-hover:bg-glass-light">
